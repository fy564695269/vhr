...
public interface EmployeeDao {
    ...
    List<Employee> getEmpByPage(@Param("page") Integer page, @Param("size") Integer size, @Param("employee") Employee employee, @Param("beginDateScope") Date[] beginDateScope);

    Long getTotal(@Param("employee") Employee employee, @Param("beginDateScope") Date[] beginDateScope);

    Integer getMaxId();

    int addEmpList(@Param("list") List<Employee> list);
